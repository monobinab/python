...
inFile = '/Users/msaha/PycharmProjects/ors/input_data/request.txt'
...
outFileDir = '/Users/msaha/PycharmProjects/ors/output_data/'
...
with open(inFile, 'r+') as f:
    for eachLine in inFileHandle:
        ...
        try:
		    ...
		    #outputLine = "{" + "\"" + "log_type" +  "\"" + ":" + "\"" + str(issueType) + "\"" + "," + "\"" + "member_id" + "\"" + ":"  + str(memberId) + "," + "\"" + "issue_time" + "\"" + ":" + "\"" + issueTime + "\"" + "," + "\"" + "offer_type" + "\"" + ":" + "\"" + offerType + "\"" + "," + "\"" + "offer_code" + "\"" + ":" + "\"" + offerCd + "\"" + "," + "\"" + "product_group" + "\"" + ":" + "\"" + productGrp + "\"" + "," + "\"" + "product_subgroup" + "\"" + ":" + "\"" + productSubGrp + "\"" + "," + "\"" + "number_of_offers" + "\"" + ":" +  numberOfOffers  + "," + "\"" + "max_catalina_offers" + "\"" + ":"  + maxCatalinaOffers + "}" + "\n"  

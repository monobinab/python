...
from issuance_parser_function import *
...
stagingFile = '/home/monobina_saha/data/output_files/issuance_log.txt'
stagingFileHandle = open(inFile, 'r')
raw_input  = '/home/monobina_saha/data/input_files/row_json.json'
...
parser_json(raw_input)
#print input_rows

if tablename in tablelist:
	print ("table exists")
	for row in stagingFileHandle:
		row = json.loads(row)
		body = {
			"rows":[{"json":row}]
			}	

...
for line in sys.stdin:
  try:
    ...
    if line is not None:
        ...
        for field in fields:
            if "LoggingBolt" in field or "PERSIST:" or ": source:"in field:
                # head part
    ...
    outputline = headDate + "|" + str(tailDate_2) + "|" + lid + "|" + modelId + "|" + oldScore + "|" + newScore + "|" + str(minExpiry_1) + "|" + str(maxExpiry_1) + "|" + source_1
